...
//       {/* Title */}
//       <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[72px] font-light leading-tight mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-gray-400">
//         Services
//       </h1>

//       <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-4xl mb-16 leading-relaxed">
...
<div className="flex justify-center mb-8">
  <div className="inline-flex items-center gap-4 px-10 py-4 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-md rounded-full border border-white/30 text-base sm:text-lg md:text-xl shadow-[0px_0px_20px_rgba(255,255,255,0.1)] hover:shadow-[0px_0px_30px_rgba(255,255,255,0.2)] transition-all duration-300">
    <span className="w-4 h-4 bg-gradient-to-r from-purple-400 to-cyan-400 rounded-full animate-pulse"></span>
    <span className="font-medium">Our Services</span>
  </div>
</div>
      ...
      <div className="text-center mb-16">
        {/* <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[72px] font-light leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-gray-400">
          Services
        </h1> */}
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
          “ Empowering businesses with robust digital solutions—from engineering to cloud to intelligent automation achieve sustainable growth through cutting-edge technology.”.
        </p>
      </div>
