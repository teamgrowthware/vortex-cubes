...
<div className="relative z-20 w-full max-w-4xl text-center flex flex-col items-center pt-20 sm:pt-24 px-2">
        ...
        <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto mb-2 leading-relaxed">
          ...
          business <br className="hidden md:inline" /> growth. From custom
          software development to AI integration, we help{" "}
          <br className="hidden md:inline" /> companies stay ahead of the curve.
        </p>
        ...
        <div className="relative w-full overflow-hidden mt-10 sm:mt-12 md:mt-20 mb-6">
          <div className="flex items-center gap-6 sm:gap-10 whitespace-nowrap animate-scrollSlow">
