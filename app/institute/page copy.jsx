...
//             Transform your coding skills into a thriving career. Learn from
...
//       <section
//         id="courses"
//         className="py-16 relative -mt-6 sm:-mt-8 md:-mt-12 lg:-mt-16"
//       >
...
//                 level: "All Levels",
//                 topics: [
//                   "Fundamentals of Digital Marketing","Search Engine Optimization (SEO)",
...
//               <div
//                 key={i}
//                 className="group bg-white/5 border border-white/20 rounded-2xl p-8 hover:bg-white/10 hover:border-white/40 transition duration-300"
//               >
